...
public class DataTablesOptions : IDataTablesOptions
  {
      /// <summary>
      ...
      /// <returns></returns>
      public IDataTablesOptions SetDefaultPageLength(int defaultPageLength) { DefaultPageLength = defaultPageLength; return this; }
      /// <summary>
      /// Enables draw validation.
      /// Draw validation is enabled by default.
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions EnableDrawValidation() { IsDrawValidationEnabled = true; return this; }
      /// <summary>
      /// Disables draw validation.
      /// As stated by jQuery DataTables, draw validation should not be disabled unless explicitly required.
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions DisableDrawValidation() { IsDrawValidationEnabled = false; return this; }
      /// <summary>
      ...
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions EnableRequestAdditionalParameters() { IsRequestAdditionalParametersEnabled = true; return this; }
      /// <summary>
      ...
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions DisableRequestAdditionalParameters() { IsRequestAdditionalParametersEnabled = false; return this; }
      /// <summary>
      /// Enables parsing response aditional parameters.
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions EnableResponseAdditionalParameters() { IsResponseAdditionalParametersEnabled = true; return this; }
      /// <summary>
      ...
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions DisableResponseAdditionalParameters() { IsResponseAdditionalParametersEnabled = false; return this; }
      /// <summary>
      ...
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions UseCamelCase() { RequestNameConvention = new CamelCaseRequestNameConvention(); ResponseNameConvention = new CamelCaseResponseNameConvention(); return this; }
      /// <summary>
      ...
      /// </summary>
      /// <returns></returns>
      public IDataTablesOptions UseHungarianNotation() { RequestNameConvention = new HungarianNotationRequestNameConvention(); ResponseNameConvention = new HungarianNotationResponseNameConvention(); return this; }
