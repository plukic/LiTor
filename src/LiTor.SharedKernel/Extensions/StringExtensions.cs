...
namespace System
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Assigns replacement value if current one is null or empty.
        /// </summary>
        /// <param name="value">Current value</param>
        /// <param name="replacement">Replacement value</param>
        /// <returns>Current or replacement value</returns>
        public static string WithBackupValue(this string value, string replacement)
